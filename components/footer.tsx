...
const socialLinks = [
  {
    name: "GitHub",
    href: "https://github.com/Dariusan3",
    icon: (
      <svg
        className="w-5 h-5"
        fill="currentColor"
  ...
  {
    name: "LinkedIn",
    href: "https://linkedin.com/in/darius-osadici",
    icon: (
      <svg
        className="w-5 h-5"
        fill="currentColor"
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-neutral-800 hover:bg-neutral-700 flex items-center justify-center text-neutral-400 hover:text-white transition-colors"
